...
public class JogoRepository {
    ...
    public ObservableList<Jogo> getJogos() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                boolean isPlatinado = rs.getInt("platinado") == 1 ? true : false;
    ...
    public void salvar(Jogo jogo) {
        ...
        String sql = "INSERT INTO tb_games (titulo, plataforma, estudio," +
                "categoria, preco, data_lancamento, platinado)" +
    ...
    public void editar(Jogo jogo) {
        ...
        try {
            ...
            System.out.println("Ocorreu um erro na ediçao.");
            e.printStackTrace();
        }
